...
public class DateUtils {
  ...
  public static String dateToStrFormate(java.util.Date dateDate,String formate) {
...
//        ParsePosition pos = new ParsePosition(0);
  ...
  /**
     ...
     * @return
     */
    public static Date strToFormatDate(String strDate,String format) {
        try {
...
//        ParsePosition pos = new ParsePosition(0);
  ...
  public static List<String> getTwoDateList(String begindate,String enddate){
    List<String> list = new ArrayList<String>();
    long days = getDays(enddate,begindate);
    for(int i=0;i<days;i++){
      String datestr =  getNextDay(begindate,i+"");
      list.add(datestr);
          }
    return list;
 }
  ...
  public static long getTimeLong(String strdate){
    SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
    Calendar calendar = Calendar.getInstance();
    try {
...
//      System.out.println(getNextDay("2016-06-01", "1"));
//      System.out.println(formatToUTC(1464937426934l));
      
//      Date ymddate =   DateUtils.strToFormatDate("20160628","yyyyMMdd");
//      System.out.println(ymddate);
//        Date ymdate =  DateUtils.strToFormatDate("2016-06-28", "yyyy-MM");
//        System.out.println(ymdate);
//        String ymdstr = DateUtils.dateToStrFormate(ymddate, "yyyy-MM");
//        System.out.println(ymdstr);
        
    List<String> list = getTwoDateList("2016-01-18","2016-01-18");
   for(String str:list){
